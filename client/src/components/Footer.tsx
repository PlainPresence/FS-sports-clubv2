        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold">FS Sports Club</h3>
                <p className="text-gray-400">Multi-Sport Facility</p>
              </div>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              FS Sports Club, beside Nayara petrol pump, Madde Hotel, Daregaon, Malegaon, 423203
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400 text-sm">FS sports club, beside Nayara petrol pump,<br />Madde Hotel, Daregaon, Malegaon, 423203</span>
              </li>
              <li className="flex items-center space-x-3">
                <i className="fas fa-phone text-primary"></i>
                <span className="text-gray-400">7066990055</span>
              </li>
              <li className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 FS Sports Club. All rights reserved. Powered with Firebase & Razorpay.
            </p>
