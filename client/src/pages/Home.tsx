...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-teal-100 relative">
      {/* Glassy Sticky Header */}
      <header className="sticky top-0 z-40 w-full bg-white/70 backdrop-blur-md shadow-md border-b border-white/30">
      ...
      <main className="pt-4 pb-16">
        {showConfirmation && bookingData ? (
          ...
          <>
            ...
            <section className="max-w-5xl mx-auto mt-6 mb-8 px-4">
              <div className="rounded-3xl shadow-2xl bg-gradient-to-br from-primary/90 to-primary/60 text-white p-8 sm:p-12 flex flex-col items-center relative overflow-hidden">
                <HeroSection onBookNowClick={handleBookNowClick} />
              </div>
            </section>

            {/* About/Founder Section as Card */}
            <section className="max-w-5xl mx-auto mb-8 px-4">
              <div className="rounded-3xl shadow-xl bg-white/80 backdrop-blur-lg p-8 sm:p-12">
                {/* Header */}
                ...
                <div className="text-center mt-12 sm:mt-16">
                  <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-xl border border-white/50 max-w-2xl mx-auto">
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-white font-bold py-3 sm:py-4 px-8 sm:px-12 rounded-xl text-lg sm:text-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                    >
            ...
            {/* Tournament Section as Card */}
            <section className="max-w-5xl mx-auto mb-8 px-4">
              <div className="rounded-3xl shadow-xl bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 p-8 sm:p-12">
                <motion.div 
                ...
                >
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 sm:p-12 shadow-xl border border-white/50 max-w-2xl mx-auto">
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold py-4 px-8 rounded-full text-lg sm:text-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                    >
            ...
            {/* Booking Section as Card */}
            <section className="max-w-5xl mx-auto mb-8 px-4">
              <div className="rounded-3xl shadow-xl bg-white/90 backdrop-blur-lg p-8 sm:p-12">
            ...
            <section className="max-w-5xl mx-auto mb-8 px-4">
              <div className="rounded-3xl shadow-xl bg-gradient-to-br from-blue-50 via-green-50 to-teal-100/80 p-8 sm:p-12">
                <ContactSection />
              </div>
            </section>
          </>
        ...
        {showFAB && (
          <button
            onClick={handleBookNowClick}
            className="fixed bottom-6 right-6 z-50 bg-gradient-to-r from-primary to-primary/80 text-white rounded-full shadow-2xl p-5 flex items-center justify-center text-3xl hover:scale-110 transition-transform duration-200"
